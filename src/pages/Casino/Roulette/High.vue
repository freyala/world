        ...
        <div class="w-full flex flex-wrap">
          <div class="w-full" v-if="parseInt(allowance) > 0">
            <button type="button" class="w-full mx-auto xya-btn" @click="addAllowance(0)">
              Disable <span class="hidden xl:inline">high</span> roulette <small class="hidden xl:inline">(contract
          ...
          <div class="w-full" v-else>
            <button type="button" class="w-full mx-auto xya-btn"  @click="addAllowance(999999999999.9999)">
              Enable <span class="hidden xl:inline">high</span> roulette <i v-if="loading.maxAllowance" class="fas fa-cog fa-spin"></i>
            </button>
          </div>
        </div>
          ...
          <div v-if="parseInt(allowance) > 0" class="w-full xl:w-3/4 mt-8 xl:px-8">
            <div class="flex flex-wrap">
              ...
              <div class="w-full 2xl:w-3/4 flex flex-wrap mt-8 p-1">
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '2500000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '2500000000000000000000'">
                    2500 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '5000000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '5000000000000000000000'">
                    5000 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '10000000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn"
                          @click="rouletteBetAmount = '10000000000000000000000'">
                    10000 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '12500000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn"
                          @click="rouletteBetAmount = '12500000000000000000000'">
                    12500 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '15000000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '15000000000000000000000'">
                    15000 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <button v-else type="button"
                      class="w-full mx-auto xya-btn" @click="makeStraightBet(rouletteSelectedItem, rouletteBetAmount)">
