      ...
      <div v-if="rouletteMounted" class="flex flex-wrap mt-8 p-8">
        <div class="w-full flex flex-wrap">
          <div class="w-full" v-if="parseInt(allowance) > 0">
            <button type="button" class="w-full mx-auto xya-btn" @click="addAllowance(0)">
              Disable <span class="hidden xl:inline">medium</span> roulette <small class="hidden xl:inline">(contract
              will no longer have rights to use your XYA)</small> <i v-if="loading.allowance" class="fas fa-cog fa-spin"></i>
            </button>
          </div>

          <div class="w-full" v-else>
            <button type="button" class="w-full mx-auto xya-btn" @click="addAllowance(999999999999.9999)">
              Enable <span class="hidden xl:inline">medium</span> roulette <i v-if="loading.maxAllowance"  class="fas fa-cog fa-spin"></i>
            </button>
          </div>
        </div>
        ...
        <div class="w-full flex flex-wrap">
          <div class="w-full xl:w-1/4 mt-8 mb-6">
            ...
            <!--      mediumTable-->
            <button type="button" class="w-full mx-auto xya-btn mb-2"
            ...
            <div class="flex flex-wrap">
              ...
              <div class="w-full" v-if="rouletteFetchedData.timeLeft !== 'Finished'">
                ...
                <button v-if="rouletteFetchedData.timeLeft > 0" type="button" class="w-full mx-auto xya-btn">
            ...
            <div v-if="rouletteMounted && rouletteFetchedData.previousRound.length > 0" class="flex flex-wrap">
              <div class="w-full mt-2 xl:mt-4">
                ...
                <div v-if="bet.type === 'straight'" v-for="bet in rouletteFetchedData.previousRound">
                  <span style="word-break: break-all">{{ bet.player }}</span> <br> had bet {{ bet.betSize }} XYA on
                  number {{ bet.spaceNumber }}
                </div>
          ...
          <div v-if="parseInt(allowance) > 0" class="w-full xl:w-3/4 mt-8 xl:px-8">
            <div class="flex flex-wrap">
              ...
              <div class="w-full 2xl:w-3/4 flex flex-wrap mt-8 p-1">
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '100000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '100000000000000000000'">
                    100 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '200000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '200000000000000000000'">
                    200 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '500000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '500000000000000000000'">
                    500 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '750000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '750000000000000000000'">
                    750 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '1000000000000000000000' ? 'bg-primary-alt text-brown' : ''"
                          class="mx-auto xya-btn" @click="rouletteBetAmount = '1000000000000000000000'">
                    1000 <span class="hidden xl:inline">XYA</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap">
              ...
              <div class="w-full xl:w-3/12 flex flex-wrap">
                ...
                <div @click="rouletteSelectedItem = (Math.floor(Math.random() * 37)).toString()"
                     class="h-24 xl:h-auto w-full p-1">
                  <div class="h-full flex cursor-pointer"
...
export default {
  ...
  methods: {
    ...
    async addAllowance(amount) {
      ...
      try {
        const tx = await this.mainContract.approve(RouletteMedium.address, arg)
      ...
      const data = await this.mainContract.allowance(this.metaMaskAccount, RouletteMedium.address)
