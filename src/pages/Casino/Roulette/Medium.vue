        ...
        <div class="w-full flex flex-wrap">
          ...
          <div class="w-full" v-else>
            <button
              ...
              Enable <span class="hidden xl:inline">medium</span> roulette <i v-if="loading.maxAllowance"
          ...
          <div v-if="parseInt(allowance) > 0" class="w-full xl:w-3/4 mt-8 xl:px-8">
            <div class="flex flex-wrap">
              ...
              <div class="w-full 2xl:w-3/4 flex flex-wrap mt-8 p-1">
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '100000000000000000000' ? 'bg-primary-alt text-brown' : 'bg-transparent text-primary-alt'"
                          class="w-full xl:w-auto rounded-none border border-primary-alt hover:bg-primary-alt hover:text-brown px-4 py-2 min-h-12"
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '200000000000000000000' ? 'bg-primary-alt text-brown' : 'bg-transparent text-primary-alt'"
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '500000000000000000000' ? 'bg-primary-alt text-brown' : 'bg-transparent text-primary-alt'"
                          class="w-full xl:w-auto rounded-none border border-primary-alt bg-transparent hover:bg-primary-alt hover:text-brown px-4 py-2 min-h-12"
                ...
                <div class="w-1/3 xl:w-1/6">
                  <button type="button"
                          :class="rouletteBetAmount === '750000000000000000000' ? 'bg-primary-alt text-brown' : 'bg-transparent text-primary-alt'"
                          class="w-full xl:w-auto rounded-none border border-primary-alt bg-transparent hover:bg-primary-alt hover:text-brown px-4 py-2 min-h-12"
