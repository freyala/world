        ...
        <div class="w-full flex flex-wrap">
          <div class="w-full" v-if="parseInt(allowance) > 0">
            <button
              ...
              Disable medium roulette <small>(contract will no longer have rights to use your XYA)</small> <i
          ...
          <div class="w-full" v-else>
            <button
              ...
              Enable medium roulette <i v-if="loading.maxAllowance" class="fas fa-cog fa-spin"></i>
            </button>
          </div>
        </div>
