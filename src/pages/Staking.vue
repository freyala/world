      ...
      <div class="p-4 md:p-8 relative">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full mt-2">
            ...
            <p v-if="parseInt(totalStaked) === 0" class="text-center">Fetching...</p>
            <p v-else class="text-center">{{ parseFloat(totalStaked).toFixed(4) }} XYA</p>
          </div>
        ...
        <p class="pb-24">
          ...
          rumors that these caves was where the world had been drawing magic from, with creatures naturally being drawn
          to
          the entrances. A group of miners led by Payne, a man known for his talent in acquiring the rarest of jewels,
          had
          discovered a mystical ore unlike anything seen before.
          <br>
          <br>
