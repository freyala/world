<template>
  <section
    ...
    <div style="background: #1c1c1c; z-index: 9999; overflow-y: hidden;" v-bind:class='{"screen": !isMarketOpen}'
         class="absolute bottom-0 left-4 text-white opacity-80 pb-2w-full flex flex-col">
      <section id="section-i-1" v-bind:class='{"h-auto": isMarketOpen, "h-auto py-4": !isMarketOpen}'
        ...
        <transition name='slide-in-right'>
          <div v-show='showActivityBar'
               class='xl:w-5/12 sm:w-full w-full top-0 bottom-0 z-50 absolute right-0 bg-detail-bg flex flex-col'
            ...
            <div class='w-11/12 mt-4 mx-auto px-4 flex flex-col dark-panel absolute bottom-0 left-4 text-white opacity-80 pb-2'>
              <div class='w-full flex flex-row justify-evenly items-center h-12 sm:text-xl text-sm'>
            ...
            <div class='w-11/12 mt-4 mx-auto px-4 my-4 flex overflow-y-scroll flex-col dark-panel absolute bottom-0 left-4 text-white opacity-80 pb-2'
                 style='min-height: 80vh; max-height: 80vh'>
              <div class='sm:text-lg text-sm' v-for='(sale, index) in activityList' :key='index'>
                <div class='w-full flex flex-row justify-evenly items-center h-12 absolute bottom-0 left-4 text-white opacity-80 pb-2'>
                  ...
                  <div class='w-3/12 flex items-center  sm:mx-2 mx-4 h-auto text-start'
                       style='color: rgba(255,255,255,0.8)'>
                    <img width='40px' class='absolute bottom-0 left-4 text-white opacity-80 pb-2' v-lazy='sale.nft.image' />
        ...
        <div class="container mx-auto text-center p-4 relative">
          <h1 class="text-3xl md:text-5xl text-primary-head font-semibold">
            <span v-if='isMarketOpen'><i v-on:click='destroyMarketPlaza()'
                                         class="fas fa-long-arrow-alt-left cursor-pointer md:text-4xl text-2xl hover:text-primary-head"></i></span>
            Marketplace
          </h1>
      ...
      <div class="xl:pr-4 pr-0 pl-0 h-5/6 relative">
        <div v-if='!isMarketOpen'
             class='lg:px-8 lg:py-4 md:px-8 md:py-0 px-4 py-4 w-full h-full flex items-start justify-center overflow-y-auto'>
