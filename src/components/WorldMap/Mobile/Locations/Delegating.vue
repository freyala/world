<template>
  <transition name="slide">
    <div class="slide-in shadow-xl w-full" v-if="openWindow === 'delegate'"
      ...
      <div class="flex relative cursor-pointer mt-6" @click="setFavourite('delegate')">
        <div class="text-center w-full" style="top: 80px; line-height: 0.25">
          <small>Click to {{ favourites.includes('delegate') ? 'unfavourite' : 'favourite' }}</small>
          <p class="text-xl">Beacon of light</p>
        </div>
      </div>
