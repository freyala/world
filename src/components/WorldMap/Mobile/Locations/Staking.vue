<template>
  <transition name="slide" v-if="chainStatus === 'correct' && walletConnected && stakingMounted">
    <div class="slide-in shadow-xl relative w-full" v-if="openWindow === 'staking'"
      ...
      <div class="flex relative cursor-pointer mt-6" @click="setFavourite('staking')">
        <div class="text-center w-full" style="top: 80px; line-height: 0.25">
          <small>Click to {{ favourites.includes('staking') ? 'unfavourite' : 'favourite' }}</small>
      ...
      <div class="flex flex-wrap">
        <button v-if="rewardBalance === '0.000'" class="w-full rounded-none border border-yellow bg-transparent px-4 py-2 min-h-12">
          No rewards to claim
        </button>
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full mt-2">
          <input class="w-full border border-yellow bg-transparent px-4 min-h-12" v-model="amountToApprove" type="number">
        </div>
        <div class="w-full mt-2">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full mt-2">
          <input class="w-full border border-yellow bg-transparent px-4 min-h-12" v-model="amountToStake" type="number">
        </div>
        <div class="w-full mt-2">
          <button class="w-full rounded-none border border-yellow bg-transparent px-4 py-2 min-h-12" @click="stake(false)">
            Stake <i v-if="loading.staking" class="fas fa-cog fa-spin"></i>
          </button>
        </div>

        <button class="w-full rounded-none border border-yellow bg-transparent px-4 py-2mt-4"
                @click="stake(true)">
      ...
      <div class="flex flex-wrap">
        ...
        <button class="w-full rounded-none border border-yellow bg-transparent px-4  min-h-12 mt-4" @click="unstake(true)">
