        ...
        <div class="relative" style="cursor: grab">
          ...
          <div class="absolute w-full h-full" style="top: -1.5vw; left: -1.75vw;">
            <div class="relative w-full h-full">
              ...
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 35.347%; top: 18.5556%; width: 2.5vw;" src="/images/map/Generic_Camp.png" alt="Generic_Camp">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 45.35%; top: 60.0278%; width: 2.75vw;" src="/images/map/Generic_Poi_Large.png" alt="Generic_Poi_Large">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 78.4688%; top: 32%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 74.2625%; top: 41.458333333333336%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 62.45%; top: 42%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 54.5891%; top: 28.7222%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 52.46562500000001%; top: 82.84722222222223%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 17.1921875%; top: 26.2778%; width: 2vw;" src="/images/map/Generic_Poi_Small.png" alt="Generic_Poi_Small">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 61.99687499999999%; top: 82.63888888888889%; width: 3.5vw;" src="/images/map/Generic_Chapel.png" alt="Generic_Chapel">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 48.7453125%; top: 34.86111111111111%; width: 3.5vw;" src="/images/map/Generic_Chapel.png" alt="Generic_Chapel">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 67.565625%; top: 29.0139%; width: 2.5vw;" src="/images/map/Generic_Tower.png" alt="Generic_Tower">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 44.05%; top: 84.26388888888889%; width: 2.5vw;" src="/images/map/Generic_Tower.png" alt="Generic_Tower">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 28.6203125%; top: 29.8444%; width: 2.5vw;" src="/images/map/Generic_Tower.png" alt="Generic_Tower">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 59.0234%; top: 43.5472%;; width: 3vw;" src="/images/map/Generic_Town_Large.png" alt="Generic_Town_Large">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 44.075%; top: 16.9194%;; width: 3vw;" src="/images/map/Generic_Town_Large.png" alt="Generic_Town_Large">

              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 67.6171875%; top: 49.0556%; width: 3.5vw;" src="/images/map/Generic_Town_Small.png" alt="Generic_Town_Small">
              <img class="cursor-pointer opacity-60 hover:opacity-100 absolute z-10" style="left: 45.4344%; top: 33.22%; width: 3.5vw;" src="/images/map/Generic_Town_Small.png" alt="Generic_Town_Small">
